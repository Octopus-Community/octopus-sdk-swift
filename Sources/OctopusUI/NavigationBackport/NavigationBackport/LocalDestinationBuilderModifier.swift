...
struct LocalDestinationBuilderModifier: ViewModifier {
  ...
  @Compat.StateObject var destinationID = LocalDestinationIDHolder()
  ...
  func body(content: Content) -> some View {
    if isWithinNavigationStack {
      ...
      content
        ...
        .onValueChanged(of: pathHolder.path) { _ in
        ...
        .onValueChanged(of: isPresented.wrappedValue) { isPresented in
          if isPresented {
